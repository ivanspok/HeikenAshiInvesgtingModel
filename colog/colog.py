...
if __name__ == '__main__':
    c = colog()
    c.log("Curvy green text on red bg", style = "curvy", color = "green", fill = "red")
    c.log("Tiny red text on default BG", style = "tiny", color = "red")
    c.log("Bold default colored text on default BG", style = "bold")
    c.ReturnToDefaultModeSwitch(False)
    c.log("Tiny red text on default BG, its switching return to default mode OFF", style = "tiny", color = "red")
    c.log("SEE? SEE? SEE?")
    c.ReturnToDefaultModeSwitch(set = True, reset = True)
    c.log("Ok, I turned the switch back, for you.")
    c.log("Vivod")
